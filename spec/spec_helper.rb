...
def message_for(validator, validation, extras)
  @messages ||= YAML.load(File.read(File.join(File.dirname(__FILE__), "..", "config", "messages.yml")))
  validator = validator.split("Validation::").last
  HathiTrust::Validation::Message.new(
    validator: validator,
    validation: validation,
    level: @messages[validator][validation]["level"],
    human_message: @messages[validator][validation]["human_message"],
    extras: extras
  )
end